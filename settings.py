...
WAIT_TIME = int(os.getenv('RABBIT_MONITOR_WAIT_TIME', 300))

# Number of seconds to look back and gather stats from
RABBIT_MONITOR_STATS_WINDOW = int(os.getenv('RABBIT_MONITOR_STATS_WINDOW',
                                            WAIT_TIME))

# Sample frequency in stats window
RABBIT_MONITOR_STATS_INCREMENT = os.getenv('RABBIT_MONITOR_STATS_INCREMENT',
                                           int(RABBIT_MONITOR_STATS_WINDOW / 10),
                                           )
