...
RABBITMQ_DEFAULT_VHOST = os.getenv('SDX_RABBIT_MONITOR_DEFAULT_VHOST', '%2f')
...
WAIT_TIME = int(os.getenv('SDX_RABBIT_MONITOR_WAIT_TIME', '120'))

# Number of seconds to look back and gather stats from
RABBIT_MONITOR_STATS_WINDOW = int(os.getenv('SDX_RABBIT_MONITOR_STATS_WINDOW', '120'))

# Sample frequency in stats window
RABBIT_MONITOR_STATS_INCREMENT = os.getenv('SDX_RABBIT_MONITOR_STATS_INCREMENT', '30')
